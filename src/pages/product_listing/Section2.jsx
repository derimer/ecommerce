    ...
    <div className="row">
      <div className="col-lg-9 col-12 order-lg-2">
        ...
        <div className="product-filter-content">
          <div className="product-filter-content-inner">
            ...
            <p>Affichage de 18 résultats sur 22</p>
            {/*Product Ouder By*/}
            <form className="ordering">
              <select name="orderby" className="orderby">
                <option value="menu_order" selected="selected">tri par defaut</option>
                <option value="popularity">tri par popularité</option>
                <option value="rating">tri par prix moyen</option>
                  ...
                  <form>
                    <div className="form-field-wrapper">
                      ...
                      <select name="filter_categries" className="form-full">
                        ...
                        <option value="footwear">chausseures</option>
                    ...
                    <div className="form-field-wrapper">
                      ...
                      <select name="filter_color" className="form-full">
                        ...
                        <option value="navyblue">bleu marine</option>
                      </select>
                    </div>
                    <div className="form-field-wrapper">
                      <label>Size</label>
      ...
      <div className="col-lg-3 col-12 order-lg-1 sidebar-container">
        <aside className="widget-area">
          ...
          <div className="widget">
            {/*Title*/}
            <h4 className="widget-title">Filtrer par Couleur</h4>
            {/*End Title*/}
            {/* Content */}
            <div className="widget-content">
              <ul>
          ...
          <div className="widget">
            {/*Title*/}
            <h4 className="widget-title">Filtrer par taille</h4>
            {/*End Title*/}
            {/* Content */}
            <div className="widget-content">
              <ul>
          ...
          <div className="widget">
            {/*Title*/}
            <h4 className="widget-title">étiquette produits</h4>
            {/*End Title*/}
            {/* Content */}
