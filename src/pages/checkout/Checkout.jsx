...
<div className="page-container">
  ...
  <section className="breadcrumb">
    <div className="background-image" data-background="img/bg_img/bg_001.jpg" data-bg-posx="center" data-bg-posy="center" data-bg-overlay={4}></div>
    <div className="breadcrumb-content">
      <div className="container">
        <div className="row">
          <div className="col-12">
            <h1 className="breadcrumb-title">Suivi</h1>
  ...
  <section className="sec-padding--md">
    <div className="container">
      ...
      <div className="alert-info" role="alert">
        ...
        Client fidel ? <a href="/login_register"> Connectez-vous</a>
      </div>
      {/*Alert*/}
      {/*Alert*/}
      <div className="alert-info" role="alert">
        {/*<a class="button" href="#">View Cart</a>*/}
        Vous avez un coupon ? <a href="/">entrez le code</a>
      </div>
      {/*Alert*/}
          ...
          <div className="product-checkout-customer_details">
            ...
            <div className="row billing-fields__field-wrapper">
              <p className="form-field-wrapper col-sm-6">
                <label htmlFor="billing_first_name">prénom&nbsp;<abbr className="required" title="required">*</abbr></label>
              ...
              <p className="form-field-wrapper col-sm-6">
                <label htmlFor="billing_last_name" className>Nom&nbsp;<abbr className="required" title="required">*</abbr></label>
              ...
              <p className="form-field-wrapper col-sm-12">
                <label htmlFor="billing_company" className>entreprise &nbsp;<span className="optional">(optional)</span></label>
                <input className="form-full input--lg" name="billing_company" id="billing_company" placeholder defaultValue type="text" />
              </p>
              <p className="form-field-wrapper col-sm-12">
                <label htmlFor="billing_country" className>Pays &nbsp;<abbr className="required" title="required">*</abbr></label>
              ...
              <p className="form-field-wrapper col-sm-12">
                <label htmlFor="billing_address_1" className> addresse &nbsp;<abbr className="required" title="required">*</abbr></label>
              ...
              <p className="form-field-wrapper col-sm-12">
                <label htmlFor="billing_city">ville&nbsp;<abbr className="required" title="required">*</abbr></label>
              ...
              <p className="form-field-wrapper col-sm-12">
                <label htmlFor="billing_city">etat&nbsp;<abbr className="required" title="required">*</abbr></label>
              ...
              <p className="form-field-wrapper col-sm-12">
                <label htmlFor="billing_phone">téléphone &nbsp;<abbr className="required" title="required">*</abbr></label>
              ...
              <p className="form-field-wrapper col-sm-12">
                <label htmlFor="billing_email"> addresse email  &nbsp;<abbr className="required" title="required">*</abbr></label>
                    ...
                    <td data-title="Shipping">
                      <ul className="shipping_method">
                        <li>
                          ...
                          <label htmlFor="shipping_method_0_flat_rate2">forfait: <span className="woocommerce-Price-amount amount"><span className="woocommerce-Price-currencySymbol">€</span>10.00</span></label>
                        </li>
                        <li>
                          ...
                          <label htmlFor="shipping_method_0_free_shipping3">livraison gratuite</label>
                        </li>
                        <li>
                          ...
                          <label htmlFor="shipping_method_0_local_pickup4">retrait en boutique <span className="woocommerce-Price-amount amount"><span className="woocommerce-Price-currencySymbol">£</span>0.00</span></label>
                        </li>
                      </ul>
                    </td>
                  </tr>
                ...
                <ul>
                  <li>
                    ...
                    <div className="payment_method_cheque">
                      <p>
                      Veuillez envoyer un chèque au nom JRD boutique.
                      </p>
                    </div>
                  </li>
                </ul>
                  ...
                  <div className="terms-and-conditions-wrapper">
                    ...
                    <p>
                      <label>
                        ...
                        <span className="woocommerce-terms-and-conditions-checkbox-text">J'ai lu et j'accepte les conditions d'utilisation du site Web</span>
                      </label>
                    </p>
                  </div>
                  <button type="submit" className="btn btn--lg btn--primary btn--full" name="checkout_place_order" id="place_order" value="Place order" data-value="Place Order">Passer la commande</button>
                </div>
              </div>
            </div>
          </div>
