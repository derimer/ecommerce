...
>
  <div
    ...
    style={{
      display: "flex", // Utilisation de Flexbox pour un comportement plus fluide
      justifyContent: "center", // Centrer l'image dans le conteneur
      alignItems: "center", // S'assurer que l'image est bien centrée verticalement
      width: "100%",
      height: "100%",
      backgroundImage: "url('/img/bg_img/img_006.jpg')",
      backgroundSize: "cover", // L'image couvre le conteneur sans déformation
      backgroundPosition: "center center", // Centrer l'image (horizontal et vertical)
      backgroundRepeat: "no-repeat",
      zIndex: -1 // Pas de répétition de l'image
    }}
    data-bg-posx="center"
    data-bg-posy="top"
    data-bg-overlay={1}
              ...
              <div className="col-lg-6 col-md-8 mx-md-auto">
                <div className="intro-caption intro-caption-middel text-center intro-caption-fade sec-padding--lg">
                  <p className="intro-subtitle">
                    SITE TYPE DEVELOPPE PAR JRD <br />
                    LES VENTES STARS DE L'ETE
                  </p>
